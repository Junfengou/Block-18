			...
			<div className="wrapper">
				<div className="specials">
					...
					<div className="specials__tag">
						<h2>
							<span className="daily">Daily Special</span>
						</h2>
						<p>
							We serve a new special every day. Head over to Facebook and see
				...
				<div className="options">
					<div className="cardZero">
						<div className="card">
							...
							<p>
								Our street-style food is bold, imaginative, and deliciously
								messy. Grab some napkins and eat up.
							</p>
							<Link to="/menu">
								<h4 className="mark">SEE MENU</h4>
							</Link>
						</div>
					</div>
					...
					<div className="cardOne">
						<div className="card">
							...
							<p>
								We use locally sourced ingredients, avoid preservatives whenever
								possible, and offer vegan-friendly dishes.
							</p>
							<Link to="/about">
								<h4 className="mark">ABOUT US</h4>
							</Link>
						</div>
					</div>
